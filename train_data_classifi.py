...
def get_args():
    ...
    parser.add_argument("--data_path", "-d", default=r"C:\Users\Public\Documents\Project_detect_emotion\ClassificationEmotion", help="Data path")
    ...
    parser.add_argument("--log_folder", "-f", type=str, default="tensorboard", help="TensorBoard log folder")
    parser.add_argument("--checkpoint_folder", "-c", type=str, default="trained_models", help="Checkpoint folder")
...
def train(args):
    ...
    train_dataset = EmotionDataset(args.data_path, "train", transform=train_transform)
    val_dataset = EmotionDataset(args.data_path, "test", transform=val_transform)
